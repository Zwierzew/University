...
public class Main {
    ...
    public static void main(String[] args){
        Student student = new Student("Finance", "I year", 3500); //odwołanie do konstruktora z 3ma parametrami
        student.setName("Julia Kowalska");
        student.setAddress("23-781 Warszawa, ul. Lotnikow 2");

        Lecturer lecturer = new Lecturer("Auditor", 7500.00d); // odwołanie do konstruktora z 2ma parametrami
